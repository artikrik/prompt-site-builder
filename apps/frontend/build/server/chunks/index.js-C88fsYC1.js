...
function resolve_route$1(id, params) {
...
function Root($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const Pyramid_2 = derived$1(() => constructors[2]);
    if (constructors[1]) {
      $$renderer2.push("<!--[0-->");
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./hooks.server-DT6FeTXc.js'));
  let reroute;
  let transport;
  return {
    handle,
...
export { ATTACHMENT_KEY as A, try_get_request_store as B, add_data_suffix as C, initial_base as D, base as E, noop as F, element as G, SvelteKitError as S, Server as a, ensure_array_like as b, attr as c, attr_class as d, escape_html as e, store_get as f, getContext as g, spread_props as h, head as i, bind_props as j, attributes as k, derived$1 as l, derived as m, clsx as n, hasContext as o, props_id as p, setContext as q, redirect as r, splitCookiesString as s, getAllContexts as t, unsubscribe_stores as u, lifecycle_function_unavailable as v, writable as w, on as x, run as y, resolve_route$1 as z };
//# sourceMappingURL=index.js-C88fsYC1.js.map
