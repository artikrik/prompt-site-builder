    ...
    function $$render_inner($$renderer3) {
      head("1i2smtp", $$renderer3, ($$renderer4) => {
        $$renderer4.title(($$renderer5) => {
          $$renderer5.push(`<title>Login - Prompt Site Builder</title>`);
        });
      });
                ...
                children: ($$renderer5) => {
                  if (Card_title) {
                    ...
                    Card_title($$renderer5, {
                      class: "text-2xl",
                      children: ($$renderer6) => {
                        $$renderer6.push(`<!---->Sign in to your account`);
                      },
                      $$slots: { default: true }
                    });
                    $$renderer5.push("<!--]-->");
                  ...
                  if (Card_description) {
                    ...
                    Card_description($$renderer5, {
                      children: ($$renderer6) => {
                        $$renderer6.push(`<!---->Or <a${attr("href", resolve("/auth/register"))} class="text-primary underline underline-offset-4">create a new account</a>`);
                      },
                      $$slots: { default: true }
                    });
                    $$renderer5.push("<!--]-->");
              ...
              Card_content($$renderer4, {
                children: ($$renderer5) => {
                  ...
                  Input($$renderer5, {
                    id: "email",
                    type: "email",
                    placeholder: "admin@promptsite.com",
                    required: true,
                    get value() {
                      return email;
                    },
...
//# sourceMappingURL=_page.svelte-D062mfuh.js.map
