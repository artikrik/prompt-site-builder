import { i as head, j as bind_props, h as spread_props, l as derived, o as hasContext, g as getContext, q as setContext, f as store_get, u as unsubscribe_stores, p as props_id, k as attributes, t as getAllContexts, b as ensure_array_like, v as lifecycle_function_unavailable, x as on, n as clsx, e as escape_html } from './index.js-C88fsYC1.js';
import { l as leads } from './leads-yGJ56Jc6.js';
import { B as Badge, p as projects } from './badge-BtfkKnbG.js';
...
import { I as Input, L as Label } from './label-T6gIAfIN.js';
import { C as Card, a as Card_content } from './card-content-3ErZKb8d.js';
import 'clsx';
import { b as boxWith, g as getDataOpenClosed, e as createBitsAttrs, s as styleToString, c as createId, a as attachRef, f as boolToStr, m as mergeProps, h as getDataTransitionAttrs, i as boolToEmptyStrOrUndef, j as simpleBox, k as boolToTrueOrUndef, l as isObject, n as executeCallbacks, o as composeHandlers, p as boxFrom, d as boolToStrTrueOrUndef, q as cssToStyleObj } from './create-id-DYnOyWbz.js';
import { c as cn } from './index-DWasNFG9.js';
import { I as Icon } from './Icon-60d8THhb.js';
import { T as Table, a as Table_header, b as Table_row, c as Table_body, d as Table_head, e as Table_cell } from './table-row-C6d5XoBP.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let newLead = { businessName: "", source: "manual", category: "" };
    const sourceOptions = [
    ...
    async function handleSearch() {
      await leads.fetchAll({ search, status: statusFilter || void 0 });
    }
    async function createProject(leadId) {
      try {
    ...
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      head("11oh0h7", $$renderer3, ($$renderer4) => {
        $$renderer4.title(($$renderer5) => {
          $$renderer5.push(`<title>Leads - Prompt Site Builder</title>`);
        });
      });
      $$renderer3.push(`<div class="space-y-6"><div class="flex items-center justify-between"><h1 class="text-2xl font-bold tracking-tight">Leads</h1> `);
      if (Dialog) {
        $$renderer3.push("<!--[-->");
        Dialog($$renderer3, {
          get open() {
            ...
            if (Dialog_trigger) {
              ...
              Dialog_trigger($$renderer4, {
                children: ($$renderer5) => {
                  Button($$renderer5, {
                    children: ($$renderer6) => {
                      Plus($$renderer6, { class: "size-4 mr-2" });
                      $$renderer6.push(`<!----> Add Lead`);
                    },
                    $$slots: { default: true }
                  });
                },
              ...
              Dialog_content($$renderer4, {
                children: ($$renderer5) => {
                      ...
                      children: ($$renderer6) => {
                        ...
                        if (Dialog_description) {
                          ...
                          Dialog_description($$renderer6, {
                            children: ($$renderer7) => {
                              $$renderer7.push(`<!---->Create a new lead to generate a website for.`);
                            },
                            $$slots: { default: true }
                          });
                          $$renderer6.push("<!--]-->");
                  ...
                  Input($$renderer5, {
                    ...
                    get value() {
                      return newLead.businessName;
                    },
                    set value($$value) {
                      newLead.businessName = $$value;
                      $$settled = false;
                    }
                  });
                  ...
                  Input($$renderer5, {
                    ...
                    get value() {
                      return newLead.category;
                    },
                    set value($$value) {
                      newLead.category = $$value;
                      $$settled = false;
                    }
                  });
                  $$renderer5.push(`<!----></div> <div class="space-y-2">`);
                  ...
                  if (Select) {
                    ...
                    Select($$renderer5, {
                      type: "single",
                      get value() {
                        return newLead.source;
                      },
                      set value($$value) {
                        newLead.source = $$value;
                        $$settled = false;
                      },
                      children: ($$renderer6) => {
                        if (Select_trigger) {
                          ...
                          Select_trigger($$renderer6, {
                            class: "w-full",
                            children: ($$renderer7) => {
                              $$renderer7.push(`<!---->${escape_html(sourceLabel())}`);
                            },
                            $$slots: { default: true }
                          });
                          $$renderer6.push("<!--]-->");
          ...
          children: ($$renderer4) => {
            if (Card_content) {
              ...
              Card_content($$renderer4, {
                class: "pt-6",
                children: ($$renderer5) => {
                  $$renderer5.push(`<div class="flex items-center gap-4 mb-6"><div class="relative flex-1">`);
                  Search($$renderer5, {
                      ...
                      children: ($$renderer6) => {
                        if (Select_trigger) {
                          ...
                          Select_trigger($$renderer6, {
                            class: "w-40",
                            children: ($$renderer7) => {
                              $$renderer7.push(`<!---->${escape_html(statusLabel())}`);
                            },
                            $$slots: { default: true }
                          });
                          $$renderer6.push("<!--]-->");
                  ...
                  $$renderer5.push(`</div> `);
                  if (store_get($$store_subs ??= {}, "$leads", leads).isLoading) {
                    $$renderer5.push("<!--[0-->");
                    $$renderer5.push(`<div class="text-center py-12 text-muted-foreground">Loading...</div>`);
                  } else if (store_get($$store_subs ??= {}, "$leads", leads).leads.length === 0) {
                    $$renderer5.push("<!--[1-->");
                    $$renderer5.push(`<div class="text-center py-12 text-muted-foreground">No leads found</div>`);
                  } else {
                    $$renderer5.push("<!--[-1-->");
                    if (Table) {
                      $$renderer5.push("<!--[-->");
                        ...
                        children: ($$renderer6) => {
                          ...
                          if (Table_body) {
                            ...
                            Table_body($$renderer6, {
                              children: ($$renderer7) => {
                                $$renderer7.push(`<!--[-->`);
                                const each_array_2 = ensure_array_like(store_get($$store_subs ??= {}, "$leads", leads).leads);
                                for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
                                  let lead = each_array_2[$$index_2];
                                  if (Table_row) {
                                    $$renderer7.push("<!--[-->");
                                    Table_row($$renderer7, {
                                      children: ($$renderer8) => {
                                        if (Table_cell) {
                                          ...
                                          Table_cell($$renderer8, {
                                            children: ($$renderer9) => {
                                              $$renderer9.push(`<div class="font-medium">${escape_html(lead.businessName)}</div> <div class="text-sm text-muted-foreground">${escape_html(lead.category || "N/A")}</div>`);
                                            },
                                            $$slots: { default: true }
                                          });
                                          $$renderer8.push("<!--]-->");
                                        ...
                                        if (Table_cell) {
                                          ...
                                          Table_cell($$renderer8, {
                                            children: ($$renderer9) => {
                                              $$renderer9.push(`<div class="text-sm">${escape_html(lead.phone || "N/A")}</div> <div class="text-sm text-muted-foreground">${escape_html(lead.email || "N/A")}</div>`);
                                            },
                                            $$slots: { default: true }
                                          });
                                          $$renderer8.push("<!--]-->");
                                        ...
                                        if (Table_cell) {
                                          ...
                                          Table_cell($$renderer8, {
                                            class: "text-sm",
                                            children: ($$renderer9) => {
                                              $$renderer9.push(`<!---->${escape_html(lead.city || lead.address || "N/A")}`);
                                            },
                                            $$slots: { default: true }
                                          });
                                          $$renderer8.push("<!--]-->");
                                          ...
                                          Table_cell($$renderer8, {
                                            children: ($$renderer9) => {
                                              Badge($$renderer9, {
                                                ...
                                                children: ($$renderer10) => {
                                                  $$renderer10.push(`<!---->${escape_html(lead.status)}`);
                                                },
                                                $$slots: { default: true }
                                              });
                                            },
                                          ...
                                          Table_cell($$renderer8, {
                                            ...
                                            children: ($$renderer9) => {
                                              Button($$renderer9, {
                                                variant: "ghost",
                                                size: "sm",
                                                onclick: () => createProject(lead.id),
                                                children: ($$renderer10) => {
                                                  $$renderer10.push(`<!---->Create Site`);
                                                },
                                                $$slots: { default: true }
                                              });
                                            },
...
//# sourceMappingURL=_page.svelte-fzBsdpwu.js.map
